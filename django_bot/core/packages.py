...
from django_bot.core.logging import get_logger
...
class PackagesLoader:
    ...
    def load_package(self, package: str, recursive: bool = True):
        """
        Функция позволяет загружать пайтон пакеты для формирования монолитной архитектуры.
        """
